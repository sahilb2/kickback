...
class Sessions(models.Model):
    session_id = models.AutoField(auto_created=True, primary_key=True, verbose_name='Session ID')
...
class SessionSongs(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, blank=False, null=True, verbose_name='Added By User')
