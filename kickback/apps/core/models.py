...
class Sessions(models.Model):
    ...
    owner = models.CharField(max_length=20, blank=False, verbose_name='Session Owner')
...
class SessionSongs(models.Model):
    ...
    username = models.CharField(max_length=20, blank=False, verbose_name='Added By User')

class CurrentSongs(models.Model):
    session = models.OneToOneField(Sessions, on_delete=models.CASCADE, verbose_name='Session ID')
    song = models.ForeignKey(SessionSongs, verbose_name='Song ID')
