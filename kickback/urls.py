...
urlpatterns = [
    ...
    re_path(r'^add_to_chat/$', kickback.apps.core.views.add_to_chat, name="add_to_chat"),
    re_path(r'^retrieve_chat/$', kickback.apps.core.views.retrieve_chat, name="retrieve_chat"),
]
